			...
			<form role="form" method="post" id="myForm">
				<div class="col-md-12">
					...
					<div class="card-body row" style="padding-bottom:1px;font-weight:bold">						
						...
						<div class="col-md-3">
							<input type="text" class="form-control" name="nm_penjual" id="nm_penjual" value="">
						</div>
					...
					<div class="card-body row" style="padding-bottom:1px;font-weight:bold">			
					<div class="col-md-2">JAM</div>
						<div class="col-md-3">
							<div class="input-group mb-1">
								<input type="time" class="form-control" name="jam_inv" id="jam_inv" value ="" >
					...
					<div class="card-body row" style="padding-bottom:1px;font-weight:bold">			
					<div class="col-md-2">KURIR</div>
						<div class="col-md-3">
							<input type="text" class="form-control" name="kurir" id="kurir" >
						</div>
						<div class="col-md-1"></div>

						<div class="col-md-2">ALAMAT KIRIM 2</div>
						<div class="col-md-3">
						...
						<table class="table table-hover table-striped table-bordered table-scrollable table-condensed" id="table_list_item" width="100%">
							<thead class="color-tabel">
								<tr>
									...
									<th style="padding : 12px 50px">Info Produk</th>
									<th style="padding : 12px 70px" >Berat</th>
									<th style="padding : 12px 70px" >Jumlah</th>
							...
							<tfoot>
								...
								<tr>
									...
									<td>
										<div class="input-group mb-1">
											...
											<input type="text" size="5" name="ongkir" id="ongkir" class="angka form-control" onkeyup="ubah_angka(this.value,this.id),hitung_total()" value='0'>
										</div>
								...
								<tr>
									...
									<td>
										<div class="input-group mb-1">
											...
											<input type="text" size="5" name="asuransi" id="asuransi" class="angka form-control" onkeyup="ubah_angka(this.value,this.id),hitung_total()" value='0'>
								...
								<tr>
									<td colspan="5" class="text-right">
										<label for="total">BIAYA JASA APLIKASI</label>
									</td>	
									<td>
										<div class="input-group mb-1">
											<div class="input-group-append">
											...
											<input type="text" size="5" name="jasa" id="jasa" class="angka form-control" onkeyup="ubah_angka(this.value,this.id),hitung_total()" value='0'>
...
<script type="text/javascript">
		...
		$.ajax({
			...
			success: function(data) {
				if(data){
					...
					$("#nm_penjual").val(data.header.nm_penjual);
					$("#nm_pembeli").val(data.header.nm_pembeli);
					$("#jam_inv").val(data.header.jam_inv.substr(0,5));
					...
					jasa_ok = (data.header.jasa=='' || isNaN(data.header.jasa) || data.header.jasa == null) ? '0' : data.header.jasa;
								...
								<tr>
									...
									<td>
										<div class="input-group mb-1">
											...
											<input type="text" size="5" name="ongkir" id="ongkir" class="angka form-control" onkeyup="ubah_angka(this.value,this.id),hitung_total()" value='${format_angka(ongkir_ok)}'>
										</div>
								...
								<tr>
									...
									<td>
										<div class="input-group mb-1">
											...
											<input type="text" size="5" name="jasa" id="jasa" class="angka form-control" onkeyup="ubah_angka(this.value,this.id),hitung_total()" value='${format_angka(jasa_ok)}'>
	...
	function kosong()
	{
		...
		$("#jam_inv").val('') 
		$("#alamat_kirim1").val('Guntara Ajie Prakosa (6285647553198)') 
		$("#kurir").val('') 
		$("#alamat_kirim2").val('Perumahan Springville Residence JL. Mangesti Raya kav B1, Waru Baki, Kab. Sukoharjo, 57556 Jawa Tengah') 
	...
	function simpan() 
	{
		...
		$.ajax({
			url        : '<?= base_url(); ?>Logistik/insert_inv_tokped',
			type       : "POST",
